...
export const booksreducer = createReducer(
    ...
    on(BooksApiActions.loadBookListError,(state, {error})=>({...state, loading: false, error})),
    on(BooksApiActions.loadBooksListSuccess,(state, {books})=>({...state, items: books,loading: false})),
)